...
function compareDatesForButton(gigDateTime, url){
    ...
    if(Date.now() > gigParsedDateTime){
        return(<a className="gig-ticket-button gig-ticket-button-passed" href={url} target="_blank" rel="noreferrer">I Was There</a>)
    }else{
        return(<a className="gig-ticket-button" href={url} target="_blank" rel="noreferrer">Tickets</a>)
    }
}
    ...
    return(
        ...
        <div className="gig-container">
            <div className = "gig-info-container">
                ...
                <h2 className="gig-location-street">{gig.gig.venue.streed_address}</h2>
                <h2 className="gig-location-city">{gig.gig.venue.city}</h2>
                <h2 className="gig-location-postal-code">{gig.gig.venue.postal_code}</h2>
